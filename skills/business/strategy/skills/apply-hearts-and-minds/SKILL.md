...
tags: [business, strategy, three-kingdoms, hearts-and-minds, zhuge-liang, meng-huo, genuine-commitment, post-acquisition, organizational-change, community, compliance]
verified: true
---

# Apply Hearts and Minds
...
### Step 1: Determine whether genuine commitment is actually required
...
### Step 2: Identify the counterpart's actual objection — what must they believe to commit genuinely?
...
- A founder resisting acquirer culture change: "your way is not better, just different"
- An open-source community resisting a license change: "you are extracting, not contributing"
- A sales prospect resisting closure: "the risk to me exceeds the benefit at this price"
- A regulatory body resisting compliance: "the rule is arbitrary, not protective"
...
### Step 3: Demonstrate capability superiority — establish the reality of the situation
...
- **Unambiguous:** The counterpart must not be able to attribute the outcome to luck, a specific disadvantage, or a tactical error
- **Complete:** Do not stop short of full demonstration — a partial demonstration allows partial rationalisation
- **Not punitive:** The demonstration establishes reality; it does not punish. Punishment produces resentment that blocks genuine conviction
...
### Step 4: Release — allow the counterpart to withdraw and reflect

After each demonstration, release the counterpart fully. This is the mechanism that converts demonstration into conviction:

- The release signals that the goal is voluntary commitment, not enforced submission
- The counterpart must be seen to choose re-engagement, not to be trapped
- The interval between capture and return is where the counterpart processes the logic of the demonstration, tests alternative rationalisations, and — eventually — runs out of them
...
### Step 5: Repeat — each cycle removes one rationalisation
...
### Step 6: Confirm the commitment is genuine before treating it as durable

The difference between genuine commitment and tactical submission under duress is verifiable:

- **Genuine:** The counterpart can articulate why your position is correct, not just that they accept it
- **Genuine:** The counterpart acts consistently with the commitment when enforcement is absent
- **Tactical:** The counterpart complies when monitored but defects when not
- **Tactical:** The counterpart cannot articulate the logic — they have memorised the required answer
...
- Never begin the cycle without knowing the counterpart's specific objection. Demonstrations that do not address the actual objection produce frustration, not conviction. The counterpart must reach a specific internal conclusion — identify that conclusion first.
- The release must be genuine. A release that is conditional, monitored, or circumscribed signals that the goal is submission, not conviction, and will be read as such. Release the counterpart fully between each cycle.
- Do not modify the terms between cycles. The counterpart is testing whether the logic of your position is sound, not negotiating. Changing terms suggests the logic was not sound after all.
- Distinguish resentment from resistance. A counterpart who becomes increasingly resentful with each cycle is not approaching conviction — they are approaching permanent defection. Resentment signals that the demonstration is being experienced as punitive, not logical. Adjust the framing, not the substance.
- Do not confuse the end of resistance with genuine commitment. Exhaustion and genuine acceptance look similar in the short term. Test for genuine commitment before treating the cycle as complete.
- Stop the cycle if genuine commitment is not reachable. Some counterparts will not reach genuine commitment regardless of the number of cycles — their objection is not rational, or their identity is too bound up in resistance. Recognise when to shift from hearts-and-minds to a different approach (exit, replacement, or sustained enforcement).

## Examples

**Satya Nadella's Microsoft culture transformation (2014–2019):**
Nadella inherited a Microsoft defined by internal competition (stack ranking), hostility to open source, and market decline. He did not mandate the "growth mindset" culture — he demonstrated it through specific reversals: eliminating stack ranking, open-sourcing .NET Core, partnering with Linux, acquiring GitHub without changing its culture. Each demonstration addressed a specific engineer rationalisation ("Microsoft just says the right words but doesn't change"). By 2019, the culture transformation was sufficiently genuine that engineers enforced it themselves — the external demonstrations were no longer necessary because the internal conviction had taken hold.
