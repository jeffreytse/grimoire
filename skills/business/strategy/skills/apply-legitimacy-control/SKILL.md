...
tags: [business, strategy, three-kingdoms, legitimacy-control, cao-cao, standards, platform, regulatory, authority, three-kingdoms]
verified: true
---
...
### Step 1: Map the sources of legitimacy in the market
...
### Step 2: Identify the legitimacy source whose control requires competitors to conform to your definition
...
### Step 3: Position for control — chair, draft, fund, and certify
...
### Step 4: Exercise the legitimacy to encode your choices as requirements
...
- A technical standard that requires the API design you have already built means competitors must build to your API
- A certification checklist that includes the security controls you have already implemented means competitors must implement your architecture
- An analyst category definition that emphasises the capabilities you lead in means competitors are evaluated on your terms
- A regulatory definition that encodes your deployment model as the baseline means competitors must achieve your baseline before differentiating
...
### Step 5: Maintain the appearance and reality of legitimate service
...
- The legitimacy source must be genuine. A manufactured standard body, a captured certification program, or a fake analyst category has no authority that competitors are obligated to respect. The strategy works only when the legitimacy is real — when the market genuinely treats the source's outputs as authoritative. Do not attempt this strategy with a legitimacy source that the market does not actually recognise.
- Control must be exercised through genuine contribution. Contributing substantive technical work that earns influence is the mechanism; procedural manipulation that installs control without merit is the failure mode that produces legitimacy capture challenges from competitors. The contribution must be real.
- The choices encoded must have technical or market merit. A standard requirement that has no defensible justification will be challenged and overturned. Encode your choices because they are genuinely better choices that happen to reflect your competitive position — not because they are your choices.
- Maintain the open process. A process from which competitors are excluded produces a standard that competitors are not obligated to recognise. The leverage of the standard depends on its universal adoption — which requires competitors to have participated, even if their influence was limited by your superior contribution.
- Monitor for capture narrative and respond with genuine service. When competitors argue the standard is captured, the argument is dangerous regardless of its accuracy — because it invites other participants to reconsider the authority of the standard. Respond substantively, not defensively: open more of the process, publish more of the justification, and demonstrate that the standard genuinely serves the market.
- Do not consume the legitimacy faster than you replenish it. Every use of the standard to advantage yourself at the market's expense depletes the legitimacy that makes the control valuable. The standard can be used to advantage yourself at competitors' expense — that is the point — but it must continue to serve the market's genuine needs. A standard that the market comes to see as serving only its controller will be replaced.

## Examples

**Microsoft Office Open XML standardisation (2007–2008):**
Microsoft's Office file formats (DOCX, XLSX, PPTX) were proprietary — government procurement officers in multiple countries were adopting policies that required open standards, which threatened Microsoft's government contracts. Microsoft submitted OOXML to ECMA International, then sought ISO ratification. The process was controversial — critics argued Microsoft had packed national standards body committees with partners to secure the necessary votes. The standard was ultimately ratified (ISO/IEC 29500:2008). The outcome: Microsoft's file format choices became an international standard, enabling government procurement officers to tick the "open standard" checkbox while continuing to buy Microsoft products. Competitors who wanted to meet the government procurement requirement had to implement Microsoft's format — competing with Microsoft became conforming to Microsoft's choices.

**GSMA 4G standard definition:**
The GSMA's definition of what qualifies as "4G" was developed through a process in which the largest mobile operators — whose infrastructure investment decisions had already been made — were the most substantive contributors. The standard encoded deployment parameters that the major operators' existing networks already met or were close to meeting. Smaller operators and new entrants faced a compliance threshold calibrated to the incumbents' already-deployed infrastructure. The "4G" label — which customers came to use as a shorthand for quality — was controlled by the incumbents through the standards process that defined it.

**Platform API as legitimacy source:**
