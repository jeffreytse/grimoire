...
### Step 1: Identify your credibility gap — what does each audience need to believe before engaging?
...
### Step 2: Cultivate genuine associations before you need to deploy them

Borrowed credibility cannot be manufactured on demand — it requires authentic relationships built in advance:

- **Advisors:** Identify 3–5 domain experts whose credibility matters to your primary audience. Engage them substantively — not just for the title, but for genuine input on product, market, or strategy. Their association is more credible when the relationship is real.
- **Design partners:** Identify potential early customers in your target segment who are willing to engage before the product is complete. A design partner relationship — where the company shapes the product — is a genuine and credible association.
- **Institutional investors:** Even a small cheque from a recognisable fund provides association. An institutional investor whose name your target audience respects signals quality judgment more effectively than a larger cheque from an unknown angel.
- **Institutional affiliations:** Accelerator participation (YC, Techstars, Entrepreneur First), research institution partnerships, standards body membership — these provide institutional association even before the company has customers.

### Step 3: Deploy strategically — match association to audience and context
...
### Step 4: Maintain the relationships behind the associations

Borrowed credibility degrades if the underlying relationship deteriorates:
- An advisor who has not been consulted in 12 months will decline to speak as a reference
- A design partner who was never deployed will not confirm the relationship in a customer reference call
- An investor whose name you use in presentations should be aware and aligned
- An institutional affiliation that has expired should be retired from materials
...
### Step 5: Transition from borrowed to earned credibility on a defined timeline

Borrowed credibility is scaffolding. The building is earned credibility:
- Design partner logos → paying customer logos
- Named advisors → board members with active governance roles
- Institutional investor name → series of institutional rounds with verifiable metrics
- Analyst mention → Gartner Magic Quadrant or similar placement
...
- All associations must be genuine and with the counterpart's knowledge and consent. Using a company's logo without permission, inflating a conversation to a "partnership," or listing an advisor who has not agreed to the title is misrepresentation — not borrowed credibility.
- Match the association to the audience's specific credibility question. A VC brand impresses seed investors; a Fortune 500 design partner impresses enterprise buyers; a domain expert advisor impresses technical evaluators. Deploying the wrong signal to the wrong audience produces no effect or negative effect.
- Do not lead with borrowed credibility as a substitute for substance. Sophisticated audiences probe. Borrowed credibility opens the door; the conversation behind the door must have substance. Prepare for the probe — what specifically has the advisor contributed? What stage is the design partner at? What metrics did the pilot produce?
- Retire stale associations. An accelerator batch from three years ago, a design partner who never deployed, an advisor who left the industry — these are no longer active borrowed credibility. Listing them when they can no longer be activated is misrepresentation.
- Convert borrowed to earned on a schedule. Set explicit targets: by Series A, three paying customers, not three design partners. By Series B, an analyst placement, not just an analyst mention. Borrowed credibility that is not converted is not a strategy — it is indefinite deferral.
