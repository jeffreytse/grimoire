...
### Step 1: Map the competitor's critical dependencies
...
### Step 2: Identify which dependency is most critical and most accessible

Rank dependencies by two dimensions:
- **Criticality:** If this dependency is disrupted, how significantly does the competitor's capability degrade?
- **Accessibility:** How difficult is it for you to reach and disrupt this dependency?
...
### Step 3: Target the dependency before the competitor can substitute
...
### Step 4: Execute the disruption specifically and completely

The disruption must be specific enough to actually degrade the source, not just inconvenience the competitor:

- **Talent disruption:** Recruit the specific individuals whose departure creates a skill or knowledge gap, not just anyone from the competitor's organisation
- **Supply disruption:** Sign exclusive agreements with the supplier, or become the preferred partner that occupies the supplier's production capacity
- **Patent disruption:** Challenge the specific patent claims that underlie the competitor's product differentiation, or develop and publish prior art that invalidates them
- **Distribution disruption:** Sign exclusive or preferred agreements with the distribution channel the competitor depends on
- **Regulatory disruption:** Challenge the interpretation that benefits the competitor, or support the regulatory change that removes their exemption

Partial disruption that does not actually degrade the competitor's capability is a cost with no benefit.

### Step 5: Verify the disruption holds — prevent the competitor from rebuilding the source
...
- If the talent is recruited: ensure they are well-positioned at your organisation so they do not return
- If the supply relationship is captured: maintain the supplier relationship as a strategic priority, not a procurement exercise
- If the patent is challenged: prosecute through the full legal process; do not settle for a cross-license that restores the competitor's position
- If the distribution is locked up: invest in the distribution partner's success so they prefer to maintain the exclusive relationship

## Rules

- Identify the critical dependency, not the convenient one. The most accessible disruption target is not always the most critical. Disrupting a non-critical dependency wastes resources and signals your strategy without impact.
- Move before the competitor can substitute. Source disruption's window is the time between your action and the competitor's substitution. Once they have rebuilt the source, the disruption is over.
- Verify the disruption actually degrades capability. A disruption that inconveniences the competitor without degrading their product or market position is a cost to you with no strategic benefit. Test the impact of the disruption before declaring success.
- Do not over-index on a single source disruption. Sophisticated competitors have redundant sources. Map and address the primary dependencies; do not assume one disruption will be decisive.
- Distinguish legitimate source disruption from tortious interference. Competing for talent, supply relationships, and distribution is legally standard competitive practice. Deliberately inducing a party to breach an existing contract, manufacturing false information to damage a competitor's relationships, or unlawfully interfering with business relationships is tortious interference — legally and reputationally damaging.

## Examples

**GPU supply in AI infrastructure (NVIDIA as source of training compute):**
