...
### Step 1: Define the role's specific capability requirements — not the generic strong-performer profile
...
### Step 2: Distinguish capability type from capability level
...
- **Execution type vs. creation type:** Some people excel at executing defined processes with high reliability; others excel at creating new approaches in undefined situations. These are not the same capability at different levels — they are different capabilities.
- **Crisis type vs. steady-state type:** Some people perform better under pressure and constraint; others perform better with time and stability. Deploying a crisis-capable leader to a steady-state scaling role often produces boredom-driven disruption.
- **Exploration type vs. exploitation type:** Founders who excel at finding product-market fit often underperform at the scaling and process-building that follows. The same person; different operational context; different required capability type.

### Step 3: Profile each candidate against the role-specific requirements
...
- What direct evidence exists that the candidate has the specific capability? Evidence means: they have done the specific thing in a comparable context, with observable results. Not: they have demonstrated adjacent capability, or they have studied the area, or they have strong general performance.
- What is the largest specific gap between the candidate's demonstrated profile and the role's specific requirements?
- Is the gap in a critical requirement (one whose absence produces the primary failure mode) or a supplementary requirement (one whose absence produces manageable degradation)?
...
### Step 4: Never deploy overall excellence as a substitute for specific fit
...
- "This person is exceptional overall" — in what specific dimension? Does that dimension match the role's critical requirement?
- "This person has my full trust" — trust is not a capability. Does the person have the specific capability the role requires?
- "This person is the most senior" — seniority is not a capability. Does the person's seniority represent accumulated experience in the specific capabilities the role requires, or in capabilities that are adjacent but different?
...
### Step 5: When no candidate has the full specific profile — assign to the closest match and fill the gap explicitly
...
- Assign the candidate whose profile covers the critical requirements most closely — not the highest-ranked overall candidate
- Identify the specific gaps explicitly and create a plan to fill them: a complement (another person assigned to cover the gap), a coach (someone who has the capability and can develop it in the assigned person), or a process (a structured check that compensates for the absent capability)
- Do not assign the highest-ranked person and hope the gaps resolve themselves
...
### Step 6: Review deployments against the specific capability requirements — update role profiles from outcomes
