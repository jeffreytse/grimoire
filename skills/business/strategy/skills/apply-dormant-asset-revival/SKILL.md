...
### Step 1: Identify dormant assets with genuine residual value
...
### Step 2: Map the residual value — what remains after the failure or dormancy?

For each candidate asset, answer specifically:
- What does this asset retain that would be expensive or slow to recreate?
- Who values that residual asset (customers, regulators, developers, investors)?
- What is the realistic lifespan of the residual value — does it degrade further over time, or is it stable?
- What liabilities come with the corpse — legal, reputational, technical, contractual?
...
### Step 3: Assess whether the residual value is genuinely enabling

Dormant asset revival is justified when:
- The residual value provides access, legitimacy, or capability that would take 12+ months to build from scratch
- The acquisition cost (cash, time, integration complexity) is less than the cost of building the equivalent from scratch
- The liabilities are bounded and manageable

It is not justified when:
- The acquisition cost exceeds the build cost
- The corpse's stigma contaminates the new initiative's market perception
- The residual value is illusory — brand recognition that is actually negative, a licence that is under regulatory scrutiny, talent that will leave on acquisition

### Step 4: Acquire or revive — and immediately separate soul from body
...
### Step 5: Signal the revival clearly — distinguish the new soul from the old corpse

The market, customers, and talent must understand that the new initiative is meaningfully different from what failed:
- Name the new initiative separately from the old entity (or if using the old brand, visibly relaunch it)
- Communicate what specifically has changed — the leadership, the product direction, the business model, the market positioning
- Use the residual credibility of what was preserved to accelerate the new initiative's market entry
- Do not lean on the old entity's narrative; create the new soul's narrative explicitly

## Rules

- The corpse must have specific, identified residual value — not just a low acquisition price. Acquiring a failed entity because it is cheap, without a clear theory of what residual value you are deploying, produces an expensive distraction.
- Map liabilities before committing. Outstanding litigation, regulatory investigations, customer disputes, and security vulnerabilities in legacy code are not visible in the asset's price. Conduct due diligence on the liabilities as thoroughly as on the value.
- Separate soul from body immediately. The longer you wait to make the separation decisions, the more the corpse's features contaminate the new initiative. Make separation decisions before or at the time of acquisition.
- Signal the new soul's distinctness clearly. A revival that looks too much like the original — same product approach, same market positioning, same team structure — invites the same failure mode. Make the differences legible.
- Do not pay for the corpse twice — in acquisition cost and in integration cost. If integration consumes the resources needed to build the new initiative, the revival fails for financial rather than strategic reasons.

## Examples

**Acqui-hire: talent and IP from failed startups:**
When a startup fails commercially but has built exceptional engineering capability or holds a relevant patent, acqui-hiring extracts the soul (talent and IP) while letting the corpse (the commercial product) be wound down. Google's acquisition of DeepMind (2014) was not an acqui-hire — DeepMind was healthy — but earlier Google acquisitions of startups like Slide, Meebo, and Scape Technologies followed the acqui-hire pattern: the commercial product was shut down, and the talent was redirected into Google's existing product lines. The corpse was the failed product; the soul was the engineering team.

**Regulatory licence acquisition:**
Square (now Block) acquired Radius Bank in 2020 to obtain an Industrial Loan Company charter, enabling Square Financial Services to take deposits and make loans without the multi-year de novo bank application process. The corpse was a community bank with limited growth prospects and a small customer base. The soul — the federal banking licence — gave Square the regulatory standing to compete in financial services immediately. The community banking operations were maintained at minimum scale while Square's financial services products were built on the regulatory foundation.

**Dormant brand revival:**
Polaroid's brand (recognised globally for instant photography) was dormant after the company's 2001 bankruptcy, but its brand equity — association with creativity, nostalgia, and the physical-photograph experience — remained valuable. Multiple companies have licensed the Polaroid brand to attach it to new instant camera and photo printer products. The brand's soul (recognition, nostalgia, creative association) survived the commercial failure; the new product companies borrowed the brand as the vehicle rather than building brand recognition for an unknown name in a crowded market.

**Abandoned standard as platform:**
When Android needed a mobile operating system, Google used the Linux kernel — an established, battle-tested, widely-deployed open-source kernel — as the foundation rather than building a new OS kernel from scratch. Linux had been designed for different use cases (servers, desktops), but its stability, security model, hardware driver ecosystem, and developer familiarity made it a valuable corpse. Android's soul — the mobile interface, the app model, the Google services integration — was built on top. The Linux foundation accelerated Android's development by years and gave it immediate compatibility with hardware vendors who already supported Linux.
