...
tags: [business, strategy, talent, signaling, costly-signal, recruiting, zhan-guo-ce, yan-ce, warring-states, information-asymmetry, market-signaling]
verified: true
---
...
### Step 1: Diagnose the recruiting failure — is it a signal problem or a product problem?
...
- The company genuinely has something valuable to offer the talent category it is trying to attract
- The reason the talent is not joining is that they don't believe the offer is real or that the company is genuinely committed to that talent category
- The company's claims are being discounted not because they're wrong but because they're indistinguishable from competitors' claims
...
### Step 2: Identify the specific gesture that would function as a credible signal to the target audience

The gesture must be:
- **Costly enough to be informative:** A gesture that would be worth making even without genuine commitment is not a signal. The cost must be high enough that only a party who genuinely values the category would incur it.
- **Visible to the target audience:** The signal must reach the people you are trying to attract. A gesture made privately has no signal value. The bones were purchased publicly; the news spread.
- **Relevant to the target audience's concerns:** The signal must address the specific uncertainty that the target audience has about your commitment. If developers doubt your commitment to open source, the signal should be an open source contribution. If enterprise candidates doubt your stability, the signal should demonstrate long-term commitment.
- **Genuine, not theatrical:** Sophisticated audiences can identify theatrical gestures (commitment that will be withdrawn when convenient) from genuine ones. The signal must be actually costly and actually irreversible.
...
### Step 3: Deploy the signal once, visibly, without hedging
...
Make the gesture:
- At the full intended magnitude, not a reduced version designed to test the market response
- Visibly, so that the target audience receives the information
- Without explicit requests for reciprocal benefit from the specific recipient — the signal is for the market, not for the recipient alone
...
### Step 4: Allow the signal time to propagate before evaluating its effect
...
- Change in inbound interest from the target talent or partner category
- Change in offer acceptance rates from the target category
- Change in the quality distribution of candidates in the target category
...
### Step 5: Do not dilute the signal with multiple smaller gestures
...
- Fix the product before signaling it. A costly signal of poor product is a waste — it attracts initial interest that converts to disappointment. Verify that the underlying value you're signaling is genuine before incurring the signal cost.
- The signal must be costly to be informative. A gesture that would be worth making even without genuine commitment carries no information. The cost is the credibility mechanism. If the gesture feels cheap or convenient, it is not a signal.
- Make the signal once, at full magnitude, without hedging. Hedged signals, signals deployed in reduced form to test market response, and signals that come with explicit expectations of reciprocal benefit are not the same as unhedged costly signals. They carry reduced information value.
- Target the signal to the specific uncertainty of the target audience. The signal must address the particular reason the target talent category is not joining. If the reason is compensation disbelief, the signal must be compensation. If the reason is culture disbelief, the signal must be a costly cultural demonstration. A signal targeting the wrong uncertainty is expensive but not effective.
- Allow 6–12 months for propagation before evaluating. Costly signal effects are transmitted through market networks, which take time. Evaluating within weeks misses the mechanism entirely.

## Examples

**千金买骨 — the original case:**
A Warring States king who wanted exceptional warhorses sent an advisor on a mission to find them. The advisor bought the bones of a dead prize horse at the full living-horse price: a thousand gold. The king was confused and angry — a thousand gold for useless bones. The advisor explained: word will spread that you paid a thousand gold for bones. Anyone with a living prize horse will know that you will pay more than that for the living horse. Within a year, exceptional living horses arrived. The bones were not the purchase — they were the signal. The thousand gold was the cost of information transmission, not of a horse.

**Microsoft's GitHub acquisition (2018):**
Microsoft acquired GitHub for $7.5 billion — a premium that many analysts considered excessive for a company with limited revenue at that time. The signal it transmitted to the developer community: Microsoft was genuinely committed to developer tools, open-source development, and the ecosystem that GitHub represented. This signal was credible because it was costly — $7.5 billion is a real commitment that Microsoft could not easily reverse. The developer community, which had been hostile to Microsoft for years due to its history with open source, updated its perception. The downstream effects — VS Code becoming the dominant code editor, Azure becoming a developer-preferred cloud platform, GitHub Copilot becoming a significant product line — were made possible by the market update the signal produced. Without the costly signal, Microsoft's claims of developer commitment would have been discounted as marketing.

**Netflix's early content licensing strategy:**
Netflix licensed content at prices that competitors (and some Netflix investors) considered unsustainable — overpaying for a catalogue that would attract subscribers. The signal to content producers: Netflix is a serious buyer who will pay well for quality content and will maintain its terms. This attracted content producers to make deals with Netflix that they would not have made with a platform they believed would retrade on initial terms. The catalogue built through these early agreements was the foundation for Netflix's subscriber growth, which eventually made the content economics sustainable. The overpayment was the cost of the signal; the content producers' willingness to make long-term deals was the return.

**Stripe's developer investment as talent signal:**
