...
tags: [business, strategy, thirty-six-stratagems, market-creation, category-design, positioning, go-to-market, create-from-nothing]
verified: true
---

# Apply Market Creation
...
### Step 1: Identify the latent pain — the problem with no name and no budget line

Latent pain has these characteristics:
- Customers experience it but cannot articulate it as a discrete problem requiring a solution
- No existing product category addresses it specifically
- The pain is real and costly — it affects outcomes that executives care about
- The pain is widespread — multiple companies experience it, not just edge cases

Methods for identifying latent pain:
- Win/loss interviews: what problem were buyers actually trying to solve before they found you?
- Customer support data: what do customers complain about that no vendor addresses?
- Job postings: what roles are companies hiring for that no software solution supports?
- Analyst blank spots: what problems appear in analyst reports as "gaps" or "emerging needs" without named solutions?

### Step 2: Name and define the category

The category name is a strategic asset:
- Use language the buyer will use when describing their problem to a peer or their board
- Make the name specific enough to be meaningful but broad enough to own the space
- Avoid names that sound like product features; create names that sound like business disciplines
- Test the name: if a buyer hears the category name and immediately thinks "that's my problem," it works
...
### Step 3: Establish yourself as the authority in the category before establishing yourself as the vendor

Category authority is built before category market share:
- **Content:** Produce definitive educational content that teaches the category's principles without selling your product. The goal is that buyers learn the category from you.
- **Thought leadership:** Publish the category's definitive research — benchmark reports, state-of-the-industry surveys, practitioner guides — that buyers share with their teams
- **Community:** Create or convene the practitioners who identify with the category — an annual conference, a practitioner Slack, a certification program
- **Analyst briefing:** Educate Gartner, Forrester, and IDC on the category definition. Getting the category recognised in analyst reports legitimises it for enterprise buyers
...
### Step 4: Create reference customers who speak in your category language

Reference customers for a new category must do two things:
1. Use your product and achieve results
2. Describe their problem and their result using your category language in public forums
...
### Step 5: Convert category authority into sales motion

Once the category is established, the sales motion shifts:
- Buyers arrive with the category's problem statement pre-formed — your sales team spends less time educating and more time qualifying
- Procurement recognises the category as a budget line item — buying is easier
- Competitors are evaluated against your category definition — their differentiation must be expressed in your terms
- New entrants validate the category (competition validates demand) rather than threatening your position, if you are established as the category king
...
- Name the problem, not the solution. Category creation starts with the buyer's pain, not your product's capabilities. A category named after your product's features is not a category — it is marketing copy.
- Be first with the category definition, not first with the product. A category creator who ships second but names the category first wins the category. Being first to market matters less than being first to define the buying criteria.
- Invest in category development as a distinct budget from product development and sales. Category creation requires content, events, analyst relations, and community — all of which produce no immediate pipeline but determine long-term market position.
- Do not let competitors redefine the category. Monitor how the market is evolving the category language. If a competitor's framing is gaining traction in analyst reports, respond with definitive content that reasserts your definition.
- Category creation requires patience. The return on category investment is typically 18–36 months from category naming to established category status. It is not a substitute for quarter-on-quarter pipeline generation.

## Examples

**Salesforce: "CRM in the cloud" vs. "a better Siebel":**
In 2000, Siebel owned CRM. A better on-premise Siebel would have required a 10-year sales cycle against Siebel's installed base. Salesforce created a new category: "No Software" (later "cloud CRM"), defined by the criterion that CRM should be delivered as a subscription service with no on-premise infrastructure. The category definition changed the buyer's decision: not "is this CRM good enough?" but "do we want an on-premise CRM or a cloud CRM?" Siebel competed in the old category; Salesforce owned the new one. By the time Siebel recognised cloud CRM as the relevant category (Oracle acquisition, 2006), Salesforce had six years of category authority.

**HubSpot: inventing "inbound marketing":**
HubSpot coined "inbound marketing" (2006) as a practitioner discipline before selling its platform. It published *Inbound Marketing* (the book), created the Inbound conference (10,000+ attendees at peak), and established HubSpot Certification as a practitioner credential. By the time buyers sought an "inbound marketing platform," HubSpot was the definition of the category — not one option among several. The category name created the demand; the platform captured it.

**Startup creating the "data observability" category (2018–2021):**
Monte Carlo Data coined "data observability" (monitoring and reliability for data pipelines) in 2018, when the problem had no name and no market. It published the "Data Reliability Report," contributed to practitioner Slack communities, briefed Gartner on the category definition, and produced the content that practitioners shared with their teams. When the category appeared in Gartner's Data Management Hype Cycle, Monte Carlo was named as a representative vendor. Competitors who entered the category later competed in terms Monte Carlo had defined — "data observability," "data SLA," "data downtime" — rather than in terms of their own choosing.
