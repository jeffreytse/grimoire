...
| Problem spans multiple domains or needs several practices coordinated | invoke `plan-best-practice-solution` |
| Complex single-domain problem, no single skill covers it | invoke `apply-best-practice-tree` |
