...
### Step 1: Identify what the opponent needs to know to counter you
...
- Your actual target segment or customer (they will call on those customers first)
- Your launch date (they will accelerate their competing release)
- Your concentration point (they will counter-concentrate resources there)
- Your walk-away point in a negotiation (they will push to just below it)
- Your key partnerships or distribution plans (they will attempt to block access)

### Step 2: When strong, appear weak — draw the opponent toward you
...
### Step 3: When weak, appear strong — deter engagement you cannot win
...
### Step 4: Feint — create a false signal in the wrong direction
A feint is a visible action that signals one intention while the true action proceeds undetected.

**Business feints:**
- File a patent in a technology area adjacent to your true development direction, signalling a roadmap the opponent responds to while the real roadmap advances elsewhere
- Announce a hiring push in a market segment you are not targeting, drawing the opponent's response to the wrong geography
- Make a minor acquisition in a non-core area that dominates industry press while the core deal or launch proceeds quietly
- Announce a product in an adjacent category to absorb competitive response before launching the true product
...
### Step 5: Control timing — move when unexpected
...
**Timing principles:**
- Launch when the competitor is at their most distracted (during a major internal transition, a product crisis, a leadership change, or their own launch event)
- Announce at a time when news cycles or industry events prevent an immediate competitive response
- Execute the decisive move at a speed that exceeds the opponent's decision cycle — they identify the threat only after the position is established

### Step 6: Maintain the deceptive posture until it is no longer needed
...
- This principle governs what you reveal to competitors, not what you represent to customers, investors, or regulators. Misrepresentation to customers (false product claims), investors (material omissions), or regulators (compliance fraud) is illegal and unethical.
- Never signal concentration before it is established. The element of surprise is the force multiplier. Once the opponent knows your concentration point, they can counter-concentrate.
- Feints require credible commitment. A half-hearted feint is transparent and provides no misdirection. If you feint, commit resources to make it convincing.
- Maintain formlessness at the organisational level. Employees talk; partners leak. Limit knowledge of the true strategic concentration to the minimum number of people necessary to execute it.
- Transition to transparency after the position is secured. Long-term competitive advantage is built on customer trust and market credibility — deceptive postures are tactical, not permanent.

## Examples

**Apple's product announcement strategy:**
...
**Negotiation — walk-away discipline:**
...
**Startup launch — feint before the real move:**
