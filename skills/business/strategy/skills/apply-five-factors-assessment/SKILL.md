...
### Step 1: Define the engagement precisely
...
### Step 2: Score 道 — Moral Law (alignment and mission)
...
- 5: Deep mission alignment, high morale, low attrition, people go beyond their job description
- 3: Adequate commitment, typical corporate motivation, execution follows incentives
- 1: Mercenary culture, high attrition, conflicting internal agendas, poor morale
...
### Step 3: Score 天 — Heaven (timing and environment)
...
- 5: Market timing is ideal; regulatory tailwinds; technology cycle on your side; competitor weakened by external events
- 3: Neutral environment; timing is acceptable but not exceptional
- 1: Poor timing; macro headwinds; regulatory pressure; technology cycle favours the incumbent
...
### Step 4: Score 地 — Earth (terrain and market structure)
**The question:** On what ground is this battle being fought? Who does the terrain naturally favour?

Score 1–5:
- 5: The terrain clearly favours you — your distribution channels, geographic strength, customer relationships, or technical platform are better suited to this market
- 3: Neutral terrain; both parties have access to the same ground
- 1: The terrain clearly favours the opponent — their existing distribution, brand awareness, or switching costs make the ground their home court
...
### Step 5: Score 将 — Commander (leadership quality)
...
- 5: Significant leadership advantage — proven track record, faster decision cycles, better judgment, lower commander faults (see `apply-tactical-adaptation`)
- 3: Comparable leadership; outcome will be decided by execution
- 1: Leadership disadvantage — slower decisions, more political friction, less experienced

**Modern translation:** 将 maps to executive team quality, decision-making speed, and organisational coherence at the top. A better-resourced opponent with slower, more political leadership can be beaten by a smaller, faster, more decisive team.

### Step 6: Score 法 — Method (organisation and discipline)
**The question:** Whose systems, processes, and execution discipline are superior?

Score 1–5:
- 5: Superior operational systems — better data, better processes, more disciplined execution, shorter feedback loops
- 3: Comparable operational capability
- 1: Operational disadvantage — fragmented systems, poor execution consistency, long feedback loops
...
- 道: Recruit mission-aligned people; clarify the why
- 天: Wait for better timing; catalyse an external change
- 地: Open a new channel; enter a sub-segment where the terrain is different
- 将: Upgrade leadership; improve decision-making structure
- 法: Build better systems before competing

## Rules

- Never assess yourself in isolation. Every score is comparative against a specific opponent in a specific context.
- Score honestly. Overrating your own factors is the most common failure mode. Have an external party validate your scores.
- Reassess when the context changes. Factors that favoured you last year may not this year — timing (天) especially changes fast.
- Do not proceed on a single dominant factor. A 5 on 道 does not compensate for 1s on 地 and 法. The framework requires multi-factor advantage.
- The assessment is a go/no-go gate, not a guarantee. Favourable factors improve probability; they do not determine outcome.

## Examples

**Startup entering an incumbent's market:**
- 道: 5 (mission-driven team, low attrition) vs. 2 (incumbent has cultural drag)
- 天: 4 (AI cycle disrupting incumbent's product) vs. 2
- 地: 2 (no distribution) vs. 5 (incumbent has dominant channels)
- 将: 4 (fast decision-making founders) vs. 3
- 法: 3 vs. 4 (incumbent has mature operational systems)
- Total: You 18, Opponent 16 — marginal advantage. Proceed, but through a new channel (地 gap is critical risk). Do not fight on incumbent's terrain.

**Enterprise sales deal (competitive pitch):**
- 道: 4 (team believes in the product) vs. 3
- 天: 5 (prospect's incumbent just had a security breach — timing is exceptional)
- 地: 3 (neutral — neither has prior relationship with this buyer)
- 将: 4 (better executive sponsor) vs. 3
- 法: 4 (better sales process, case studies ready) vs. 3
- Total: You 20, Opponent 12 — clear advantage. Commit full resources to this deal.
