...
### Step 1: Identify whether you are in a post-crisis trap structure
...
### Step 2: Monitor the crisis resolution timeline — identify the inflection point
...
- The crisis narrative in the principal's communications shifts from "ongoing emergency" to "successful resolution"
- New leadership appointments are made for functions you covered during the crisis
- The principal's relationship with you becomes more formal and procedural
- Questions arise (from board, investors, senior leadership) about "what comes next" in terms of organisational structure
- The principal begins consulting others on questions that were previously your sole domain
...
- Allows you to frame the transition as voluntary and principled
- Preserves the relationship at a sustainable level
- Protects your reputation with third parties who observe the transition
- Avoids the defensive posture that comes from responding to the principal's action rather than initiating your own
...
### Step 5 (For principals): Recognise and design against the trap incentive
...
- Create explicit retention frameworks that survive the post-crisis period (not just during-crisis compensation)
- Separate the crisis contribution evaluation from the peacetime role evaluation — these require different capabilities and the same person cannot reasonably be evaluated against both criteria simultaneously
- Provide the crisis contributor with a genuine post-crisis role that uses their capabilities in a non-threatening way, rather than marginalising them
- Recognise the structural incentive to reduce the crisis contributor's influence and design explicit governance against acting on it
...
- Act before the inflection point, not after. The transition window closes quickly once the principal has identified the threat. By the time the contributor is reacting to the principal's moves, the terms of the transition have already been defined by the principal, not the contributor.
- The trap is structural, not personal. Believing that personal loyalty, demonstrated contribution, or the principal's gratitude will prevent the trap from operating is the Wen Zhong error. The structural incentives are independent of personal feelings. Address the structure, not the relationship.
- Exceptional contribution increases the trap risk, not decreases it. The more clearly indispensable you were during the crisis, the stronger the principal's structural incentive to reduce your influence after it. The trap is strongest for the most valuable contributors.
- Dependency reduction on your terms is preferable to reduction imposed by the principal. Begin transferring knowledge and relationships before you are forced to. This preserves your agency in the transition and removes the most potent argument for why you must be marginalised.
