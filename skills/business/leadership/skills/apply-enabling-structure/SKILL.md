---
name: apply-enabling-structure
description: Use when building or leading a team, organization, or system — to create the conditions, remove the obstacles, and design the structures that let people execute with high autonomy, rather than directing through control, because the best leaders are barely visible in their teams' day-to-day success
source: "道德经 第十七章 (Laozi, ~6th–4th century BC) — 太上，不知有之；其次，亲而誉之；其次，畏之；其次，侮之; Robert Greenleaf \"The Servant as Leader\" (1970) — servant leadership; W. Edwards Deming \"Out of the Crisis\" (1982) — remove barriers, drive out fear; Ricardo Semler \"Maverick\" (1993); Jeff Bezos Amazon Leadership Principles — \"remove obstacles\"; W.L. Gore & Associates self-organizing team structure"
tags: [leadership, organizational-design, autonomy, servant-leadership, management]
verified: true
---
...
1. **Diagnose what is actually blocking your team.** Conduct a blockers audit: for each person on the team, identify what prevents them from doing their best work. Categorize blockers:
   - **Structural:** approval processes that slow decisions; tools that don't work; dependencies on other teams with unclear SLAs
   - **Informational:** unclear goals; inconsistent priorities; not knowing how decisions will be made
   - **Cultural:** fear of raising problems; perception that bad news is punished; reluctance to escalate
   - **Resource:** insufficient time, budget, access, or capacity
   The blockers audit is the central diagnostic. Most leaders believe their teams are limited by capability; most teams are limited by obstacles their leaders have not noticed.

2. **Remove or route around structural blockers.** For each structural blocker identified: eliminate the approval step that is adding delay without adding quality; fix or replace the tool that is causing friction; establish a clear SLA with the dependent team. Apply the via negativa principle: if a process or approval step cannot be traced to a specific failure it prevents, it is overhead, not governance.
...
4. **Create safety for bad news.** Information about problems flows up only if people believe reporting problems will not be penalized. The test: does your team surface problems early, or do you hear about them when they become crises? If you hear about problems late, fear exists somewhere in the information chain. Address it directly: "I need to know about problems early when I can help, not late when I can't."

5. **Transfer decisions to the person closest to the information.** For each decision currently made at your level, ask: who has the most information about this decision, and can they make it? If yes, transfer the decision. Retain only decisions that require your level's context (cross-team trade-offs, resource allocation across teams, decisions with strategic implications outside the team's scope). A leader who is making decisions their team should make is both a bottleneck and a signal that something is wrong.

6. **Measure by what the team accomplishes without you.** The test for enabling structure working: your team is executing well on days you're unavailable. If your presence is required for quality or velocity, the enabling structure is incomplete. Track: how many escalations require your personal intervention per week? What happens to output when you're out of office? Declining escalations and unchanged output are positive signals; increasing escalations and degraded output indicate remaining obstacles.

## Rules

- Removing obstacles is a higher-leverage activity than providing direction. A manager who removes one significant blocker typically unblocks more output than one who provides more direction. Prioritize the obstacle audit over the planning meeting.
- Trust must be extended before it can be earned. The leader who says "I'll give you more autonomy once you prove you can be trusted" has inverted the causality — people demonstrate capability in proportion to the autonomy they're given. Start with more autonomy than feels comfortable.
- Visibility is not the same as control. Many leaders conflate knowing what is happening (visibility) with making it happen (control). You need visibility; you usually don't need control. Design for high information flow and low intervention — not the reverse.
- Your job is not to solve your team's problems. When a team member brings a problem, resist the instinct to solve it. Ask: "What do you need from me to solve this?" Often the answer is permission, resources, or removal of an obstacle — not a solution from you.
- The best measure of enabling leadership is team attribution: when things go well, does the team feel they did it? If they attribute success to you, the team depends on you; if they attribute success to themselves, the structure is working.
...
- **Confusing activity with leadership.** A leader who is visibly busy — in every meeting, making every decision, reviewing every output — may be creating dependency rather than capability. High leader activity and high team autonomy are inversely correlated in many organizations.
- **Conducting a blockers audit once.** Blockers accumulate continuously. New processes are added; tools degrade; team composition changes; dependencies shift. The blockers audit must be a regular cadence, not a one-time exercise.
- **Removing obstacles for high performers only.** Enabling structure applies to the whole team. Leaders often identify and remove obstacles for their most visible performers and leave others to navigate the obstacles unassisted. The impact of unresolved blockers is higher on lower-visibility team members.
- **Interpreting team autonomy as leader absence.** Enabling structure requires more leadership engagement at the design and monitoring level, not less. The leader who "gets out of the way" without building enabling structures has not applied this principle — they have abdicated.
