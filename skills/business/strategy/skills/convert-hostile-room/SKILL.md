...
### Step 1: Map every major objector and their specific position before entering the room
...
### Step 2: Enter without your case — open by acknowledging the gravity of the situation

Do not begin with your positive argument. Begin with an honest acknowledgment of what the room already believes:

- "I know that most of you here have concluded that X is the right course."
- "I understand why the current evidence points toward Y."
- "I'm not here to tell you the situation is other than it is."
...
### Step 3: Engage each major objector individually by name
...
### Step 4: Expose the logical inconsistency — do not argue against their position, expose its internal contradiction
...
### Step 5: After each individual defeat, move cleanly to the next — do not press
...
### Step 6: Make your positive case briefly — after the objections have been cleared
...
- **Brief:** The room's cognitive energy has been spent on evaluating the inconsistencies in the opposition's positions. A long positive case risks losing the converted attention. State the core argument in its simplest form.
- **Forward-looking:** Do not reference the objections you have just addressed. The case is about what you are proposing, not about what you have dismantled.
- **Specific:** The room now needs to understand concretely what they are being asked to approve. Vagueness after the demolition sequence creates doubt about whether the thing you are proposing is real.
...
### Step 7: Give the group a face-saving path to agreement
...
- "The question is no longer whether the alliance is strategically sound — we've established that. The question is what terms make it work for Sun Quan."
- "I think we can agree that the earlier concerns were based on assumptions that, when we examined them together, turned out not to hold. The path forward is…"
- "What each of you has correctly identified is the need for rigour in this decision. The rigour suggests the following…"
...
- Map every major objector before entering. The approach requires specific preparation for each person. Improvising the logical exposure in real time is possible for expert debaters but unreliable. Do the intelligence work before the room.
- Address by name, not collectively. Collective address allows individuals to shelter in the group. Individual address requires personal accountability for the position. The mechanism only works on specific people defending specific arguments.
- Expose internal inconsistency — do not argue the merits of your position. The goal at each objector is to make their position visibly uncertain, not to demonstrate that your position is correct. The positive case comes after. If you present your positive case while addressing an objector, you have shifted to a contested argument where the audience chooses sides.
- Do not press after exposure. The room has observed the inconsistency. Pressing produces sympathy for the objector and makes you appear aggressive rather than analytical. Move cleanly to the next person.
- Distinguish the head objector from the followers. In most hostile rooms, one or two people are driving the opposition; the others are following their lead. If you can expose the head objector's position early, the followers often reconsider before you reach them. Identify the lead and address them first or second.
- Provide the face-saving path. An agreement that requires individuals to admit defeat is fragile. An agreement reached through the face-saving framing is durable because each person can advocate for it. Design the path to agreement before the room, not in the moment.

## Examples

**Board presentation against a majority hostile to a pivot:**
...
**Investor Q&A with hostile questioners performing for each other:**
