---
name: design-speak-up-framework
description: Use when building or auditing your organization's ability to surface ethical violations, compliance breaches, safety issues, and misconduct — to design the channels, protections, and culture that make reporting wrongdoing possible and expected, because without explicit institutional design, fear of retaliation systematically suppresses the information flow that prevents catastrophic failures
source: "谷梁传 讨贼之义 (Guliang Chi, ~5th–4th century BC) — inaction in the face of wrongdoing is morally equivalent to complicity; those with standing have an obligation to act, not remain neutral; Sarbanes-Oxley Act §301 (2002); Dodd-Frank Act §922–924 (2010) — SEC whistleblower program with financial rewards and anti-retaliation protections; FCA Senior Managers & Certification Regime (SMCR, UK, 2016); Amy Edmondson \"The Fearless Organization\" (2018); Diane Vaughan \"The Challenger Launch Decision\" (1996) — suppression of safety concerns as proximate cause of disaster"
tags: [operations, compliance, ethics, psychological-safety, governance, whistleblowing]
verified: true
---
...
1. **Distinguish speak-up categories by severity and type.** A speak-up framework must handle different types of concerns with different channels and protections:
   ...
   - **Misconduct:** Harassment, discrimination, bullying, abuse of authority. Requires HR investigation with separation of accused from investigation.
   Design distinct channels for each category, since conflating them creates confusion and may result in legal violations being handled through inappropriate channels.
...
2. **Design reporting channels that match the concern type.** No single channel works for all concern types:
   ...
   - **Board-level channel:** For concerns involving senior leadership, where normal channels are compromised
   Most organizations need at least three: anonymous hotline, HR escalation, and board/audit committee channel. The key design principle: if the concern involves the person's direct manager, the channel must bypass them.
...
4. **Create a formal investigation process.** Reports that enter no process, or a process that reporters can't see, produce distrust and non-use of the channel. Design:
   ...
   - Escalation path if the reporter is unsatisfied with the outcome
   The investigation must be genuinely independent. If the CEO's direct report is investigating a concern about the CEO's conduct, the investigation is structurally compromised.
...
5. **Train leaders to receive concerns.** How leaders respond when someone raises a concern directly determines whether others will raise concerns later. Train all managers and leaders to:
   ...
   - Never disclose the reporter's identity without consent
   The most common failure mode: a manager responds to a spoken concern with visible discomfort or defensiveness, and the reporter concludes that speaking up was a mistake. This one interaction suppresses future reporting across the entire team.
...
6. **Measure speak-up health.** Use of speak-up channels is a health indicator, not a failure indicator. Establish metrics:
   ...
   - Retaliation incidents within 12 months of report
   Report these metrics to the audit committee or board quarterly.
