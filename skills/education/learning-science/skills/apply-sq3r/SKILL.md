...
- **Slow down at definitions, examples, and diagrams** — these carry disproportionate information density
- **Mark confusion points** with a ? in the margin (don't stop to resolve them now)
- **Resist highlighting during first pass** — you don't yet know what's most important; highlighting on first read picks up everything
- Read the section until you can answer the question — if you cannot, re-read that section only before moving to the next

Do NOT read the whole chapter before doing Step 4. Complete Steps 3–4 section by section.

### Step 4 — Recite (the highest-impact step)
...
- Never skip the Question step — reading without pre-formed questions defaults to passive reception; the questions are the cognitive activation that makes Steps 3–4 work.
- Never highlight during Step 3 — highlight or annotate during Review only, after you know what matters.
- Recite with the text closed — "reciting" while looking at the text is re-reading, not retrieval; it eliminates the method's primary mechanism.
- Apply section by section, not chapter then recite — working memory cannot hold an entire chapter; section-level cycling is how the method was designed.

## Common Mistakes

- **Surveying = reading** — Survey is fast (2–5 min); if it's taking longer, you are reading, not surveying. Headings and first sentences only.
- **Treating Recite as optional** — SQ3R without the Recite step is just structured reading. Recite is 80% of the retention benefit; the other steps set it up.
- **Writing questions too broad** — "What is this section about?" is not a question; it produces no mental search. "What are the three mechanisms by which X causes Y?" forces specific retrieval.
- **Applying SQ3R to narrative text** — SQ3R is designed for expository/informational text with headings. Fiction, narrative history, or prose without structure needs different techniques (e.g., literature annotation, timeline mapping).
