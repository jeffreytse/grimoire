...
### Step 1: Define what you are actually competing for
...
### Step 2: Apply proportionate force at each stage
...
### Step 3: Avoid pyrrhic tactics — identify win-conditions that preserve the prize
...
### Step 4: Preserve the strategic reserve
...
- Never commit 100% of resources to a single campaign, regardless of how decisive it appears
- The reserve is not unused capacity — it is committed capacity held back for follow-on opportunity or unexpected response
- Define the reserve size before the campaign begins and enforce it during execution, not after
- When a campaign ends — win or lose — assess reserve status before committing to the next campaign

**Minimum reserve thresholds (heuristic):**
- Financial: maintain 6+ months operating runway after campaign budget is committed
- Talent: maintain 15–20% capacity not assigned to the active campaign
- Leadership attention: reserve capacity for next-opportunity assessment, not just current execution

### Step 5: Know when to stop pressing
...
- The objective is achieved (market position established, deal signed, customer committed)
- Continuing to press provokes a response that risks what has already been won
- The opponent's posture has shifted from active competition to management of their remaining position
- Resources consumed per unit of additional gain are rising steeply
...
- Define the prize's full value before committing force. If you cannot articulate what you are competing for beyond market share, you cannot calibrate how much force the prize justifies.
- Run the pyrrhic test on every major competitive tactic. Does this tactic, if it succeeds, leave the prize intact? If not, find an alternative approach.
- Maintain the strategic reserve regardless of campaign pressure. The temptation to commit reserve capacity when a campaign is at a critical moment is the mechanism by which reserves are lost.
- Stop at the natural endpoint. The campaign that continues past decisive victory destroys the conditions for the next campaign.
- Do not initiate a price war unless you are the structural low-cost competitor. Price wars benefit the lowest-cost player; if that is not you, a price war is a contribution to your competitor's dominance.

## Examples

**Berkshire Hathaway acquisitions (preserve the prize):**
...
**Intel's response to RISC (proportionate probe, not full commitment):**
When RISC architecture threatened Intel's x86 franchise, Grove did not commit maximum resources to an x86 response at the cost of everything else. He identified that the PC market's inertia — the installed base of x86 software — was the structural defence, and invested proportionately in x86 performance improvement rather than a full architectural rewrite. Economy of force: defend the position with the minimum force required while reserving resources for the next wave.

**Price war avoidance (preserve industry margin):**
A SaaS company faces a competitor discounting 40% to win a key account. Pyrrhic test: matching the discount wins the account but signals to all other accounts that 40% discount is available on request, reducing the effective price for the entire customer base. The economy-of-force response: compete on value differentiation, not price; offer the account non-price concessions (implementation support, SLA upgrade, extended payment terms) that win without setting a price precedent.

**Negotiation endpoint (stop at decisive win):**
In a vendor negotiation where you hold significant leverage (the vendor needs your volume), economy of force says: extract the terms that make the relationship sustainable and fair over the contract term, then stop. Extracting maximum possible terms leaves the vendor margin-constrained, under-investing in your account, and looking for the first exit opportunity. A decisive but non-destructive negotiation produces better 5-year outcomes than a pyrrhic win on terms.
