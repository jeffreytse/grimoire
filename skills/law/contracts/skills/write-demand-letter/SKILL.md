...
### Step 1: Confirm your claim is legally sound before writing
...
- Original contract or agreement (written or email thread establishing oral terms)
- Invoices, receipts, or proof of payment/non-payment
- Communications documenting the breach (emails, texts, screenshots)
- Photos or estimates for property damage
...
### Step 3: Draft the letter using this structure
...
### Step 4: Set the deadline correctly
- 14 days: appropriate for clear-cut debts, returned goods, small amounts.
- 21–30 days: appropriate for amounts over $5,000, or where the recipient may need time to consult counsel.
- Do not set a deadline you cannot enforce — if you say 14 days and do nothing on day 15, your credibility is damaged.

### Step 5: Send via certified mail with return receipt + email
- **Certified mail (USPS Form 3800) with return receipt** creates a legally recognised record of delivery. Retain the green card when returned.
- **Email simultaneously** creates an instant timestamp and shows you made every effort to communicate.
- Do not send via social media or text only — these are not recognised as formal legal notice in most jurisdictions.

### Step 6: Note the response deadline on your calendar
...
- State only facts you can prove. Exaggerated claims undermine your credibility if the case proceeds to court.
- Do not make threats beyond "I will pursue legal remedies." Threatening criminal prosecution to collect a civil debt is extortion in most jurisdictions.
- Do not include emotional language. Courts disregard it; recipients use it to paint you as unreasonable.
- Keep a copy of the letter exactly as sent, the certified mail receipt, and all delivery confirmations.
- One demand letter is sufficient. Sending multiple escalating letters without filing suit trains the other party to ignore you.
- For claims involving consumer protection violations, check if your state has a specific statutory demand procedure (e.g., California's 30-day demand before filing CLRA claims) that entitles you to attorney's fees.
