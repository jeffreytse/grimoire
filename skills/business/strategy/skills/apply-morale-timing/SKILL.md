...
1. **Recognize the trigger: first-drum move.** Identify whether the move you're facing is a first-drum expression — an aggressive opening bid, the first statement of an objection, the first public accusation, the first competitive announcement. Signs of first-drum: emotional language, sweeping claims, ultimatums, high amplification (CC'd widely, announced publicly, stated loudly).

2. **Resist the instinct to respond immediately.** The first-drum instinct triggers a matching emotional response — defend, counter-offer, rebut. This is the trap. Responding at first-drum locks you into the opponent's emotional frame at their maximum emotional advantage. Instead: acknowledge receipt without engaging the substance. "I've seen this / heard this. Let me come back to you."

3. **Measure the decay.** Watch what happens after the first expression subsides:
   - Does the opponent re-state? At what intensity? (Second drum: notably weaker)
   - Do they escalate? (Rare; usually signals genuine distress rather than performance)
   - Do they retreat? (First-drum was purely positional; real position is softer)
   - Do they provide more information? (Reveals underlying interest — move to apply-interest-alignment)

4. **Engage at second-drum or later.** Respond when the emotional energy has demonstrably declined — typically after 24–72 hours in negotiations, after the initial news cycle in competitive/PR contexts, after the objector has re-stated once in a sales conversation. Your response now enters a cooler register and you negotiate from your own frame.

5. **Set your own timing when you must respond immediately.** If immediate response is required (live negotiation, real-time press conference, on-the-spot objection), apply micro-timing within the interaction: pause 3–5 seconds before responding, speak more slowly than the opponent, lower your vocal register. This creates a small morale-decay even within a single exchange.

6. **Distinguish performative from genuine first-drums.** Not all aggressive openings are performative. Genuine first-drum moves (actual deadlines, real regulatory actions, verified competitive threats) require engagement at first expression. The test: Is there verifiable evidence that the move is real and time-bounded? If yes, engage immediately. If not — wait. False urgency is almost always first-drum performance.

7. **Use the decay period for preparation, not silence.** While the opponent's morale decays, use the interval to: gather information about their actual position, confirm your alternatives (BATNA), identify the underlying interest, and draft your response from a settled frame rather than a reactive one.

## Rules

- Never counter-offer at first-drum. A counter-offer at first expression validates the opening as the real anchor and signals that aggressive openings work. Always let the first drum decay before entering substantive negotiation.
- Do not interpret patience as concession. Silence and delay signal deliberation, not weakness. If the opponent interprets your non-response as agreement: "I haven't agreed; I'm considering the full picture."
- First-drum moves in public venues (press releases, social media, regulatory filings) have a specific decay curve — 24–48 hours for initial coverage to peak. Do not respond publicly within that window unless the failure to respond is itself damaging.
- Some first-drum moves are designed to provoke an immediate defensive response that reveals your position. (cf. apply-reversal-probe in reverse.) Waiting out the first drum also prevents this information leak.
...
- **Treating all first-drums as genuine:** Some aggressive openings do reflect real deadlines or genuine crises. The test is verifiability: can the deadline or threat be independently confirmed? If yes, treat as genuine. If not, apply morale timing.
- **Confusing waiting with no-response:** Morale timing requires acknowledging receipt without engaging substance. "I've received this and will respond" is different from ignoring the move. Ignoring signals disrespect; morale timing signals deliberation.
- **Engaging at peak then waiting:** Responding immediately (even partially) resets the morale curve at the engaged position. Once you engage, the decay clock restarts. Engage once, when the morale curve has already fallen.
- **Applying morale timing to relationship damage:** If the first-drum move includes personal accusations or actions that damage trust (public criticism of an individual, breach of an agreement), delay may be read as acceptance. In these cases, acknowledge the relational dimension immediately ("I want to address this directly") while delaying the substantive response.
