...
1. **Before making any selection decision, name your relationship to each candidate.** Explicitly articulate how you know each person under evaluation. Categories: enemy or adversary, neutral/unknown, acquaintance, friend, family, former colleague, mentee, sponsor. This step is required because the reversed-relationship test cannot be applied if the relationship is not explicitly named.

2. **Apply the reversed-relationship test.** For each candidate, ask: if this person were at the opposite end of my relationship spectrum, would I still make the same recommendation? Specifically:
   - For someone you know and like: "If this person were my enemy — someone who had harmed my interests — would I still consider them the most qualified candidate?"
   - For someone you don't know or dislike: "If this person were my close ally — someone whose success I care about — would I rate them differently than I do now?"
...
3. **Re-evaluate on explicit, pre-specified criteria.** Where the reversed-relationship test reveals potential bias, evaluate the candidate exclusively on explicit criteria that were specified before reviewing applications:
   - What specific demonstrated capabilities or results does this role require?
   - What evidence does each candidate have of those specific capabilities?
   - Rank candidates by evidence, not by impression.
...
4. **Actively seek information on candidates outside your relationship network.** One of the most common failure modes of the reversed-relationship problem is the evaluation pool itself: candidates are drawn from familiar networks, so candidates who would be meritocratically superior simply are not in the pool. Before evaluating, ask: who has the required capabilities that I have not yet identified? Extend the consideration pool to candidates from outside your immediate network before evaluating within it.

5. **Evaluate comparatively, not individually.** Iris Bohnet's research establishes that evaluating candidates against each other — ranking on explicit criteria simultaneously — reduces individual bias compared to evaluating each candidate alone and reaching an independent judgment. When possible, evaluate all candidates for a role against the same criteria in the same sitting rather than sequentially over time.

6. **Document the evaluation and its reasoning.** The discipline of writing down the specific evidence that supports a recommendation exposes post-hoc rationalization that would otherwise remain invisible. If you cannot write a specific evidence-based justification — "this candidate was selected because of X demonstrated capability evidenced by Y result" — the selection was not meritocratic. The documentation also provides accountability: future outcomes can be compared against predictions.

## Rules

- The reversed-relationship test is applied to expose bias, not to reverse bias. The goal is not to disadvantage people you like or advantage people you don't — it is to identify when relationship is doing work that merit should be doing, then remove that influence.
- Specify evaluation criteria before reviewing candidates. Criteria derived after reviewing the application pool are structurally biased toward candidates already favored by other means. Criteria specified in advance provide a meritocratic standard.
- Awareness of bias does not reduce it. Bohnet's research is explicit: knowing you might be biased and intending to be fair does not produce measurably fairer outcomes in individual evaluation decisions. Structural interventions (blind review, standardized criteria, comparative evaluation) produce measurable improvement; good intentions do not.
- The evaluation pool is part of the evaluation. A meritocratic evaluation process applied to a non-representative consideration pool is not meritocratic. The reversed-relationship test must be applied not just to who gets selected from the pool, but to who gets into the pool.
...
- **Mistaking the appearance of process for the substance of merit.** A structured interview process administered by evaluators who have already decided who they want produces post-hoc rationalized justifications, not meritocratic decisions. Process is necessary but not sufficient; the reversed-relationship test is applied inside the process.
- **Applying the test only to external hires.** Promotion and recommendation decisions within an organization are more susceptible to relationship bias than external hires, because relationships are longer-established and the evaluation is typically less structured. The reversed-relationship test is most critical in internal talent decisions.
- **Confusing familiarity advantage with meritocratic advantage.** Candidates who are well-known to evaluators often appear more qualified because evaluators have more evidence about them, not because they are objectively more qualified. This familiarity advantage is a form of relationship bias: candidates who are unknown to evaluators are systematically underrated because evaluators have less evidence, not because they have less capability. Recognize familiarity as a potential source of inflation rather than a signal of superior qualification.
