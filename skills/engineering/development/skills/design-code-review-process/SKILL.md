...
3. **Write PR descriptions that enable review** — Template: What changed, Why it changed (link to issue), How to test it, Screenshot/demo for UI changes, Any risks or rollback plan. A reviewer who understands context provides better feedback. A PR without context receives surface-level review.
