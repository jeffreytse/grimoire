---
name: apply-enforcement-timing
description: Use when misconduct, policy violation, or serious wrongdoing has been detected — to determine whether to act immediately or delay enforcement until the case is overwhelming and legally unassailable, because premature enforcement against powerful bad actors weakens the case, creates procedural exposure, and enables the subject to claim overreach
source: "左传 隐公元年 (722 BC, first entry) — 郑伯克段于鄢: Zheng Zhuanggong deliberately allowed his brother Gong Shu Duan to overreach repeatedly until the wrongdoing was undeniable, then acted with unassailable justification; DOJ Federal Prosecution Manual §9-27.220 (US Department of Justice) — strength of evidence standard before indictment; SHRM documented progressive discipline standard — documented corrective action sequence before termination reduces wrongful termination litigation by ~80%; OSHA/EPA document-notify-enforce cycle for workplace and environmental violations; Delaware Chancery Court precedent on board enforcement timing against executives; Gary Pisano & Amy Edmondson governance research (HBR)"
tags: [operations, enforcement, governance, compliance, legal, misconduct, timing]
verified: true
---
...
1. **Assess the strength of current evidence.** Before making any enforcement decision, answer: if enforcement were challenged tomorrow, what is the probability the case would be upheld? Assess:
   - Direct evidence of misconduct: documented, witnessed, recorded, or otherwise unambiguous
   - Circumstantial evidence: patterns, documentation gaps, inconsistencies, behavioral signals
   - Witness reliability: who observed the misconduct and would testify credibly
   - Procedural cleanliness: was the evidence obtained through proper channels; are there any procedural defenses the subject could raise
...
2. **Begin documentation immediately on detection.** The moment misconduct is suspected, begin a contemporaneous record: date and time of observations, specific behaviors observed, who was present, what was said. Do not wait until enforcement to begin documenting — the value of documentation is that it is contemporaneous (created at the time of events, not reconstructed later). Reconstructed documentation is significantly weaker in enforcement proceedings than contemporaneous records. Create a secure, dated record from detection forward.

3. **Identify the minimum evidence threshold for each enforcement action.** Different enforcement actions have different evidence requirements:
   - **Verbal warning or documented conversation:** low threshold — a credible single incident with contemporaneous documentation
   - **Written warning or formal corrective action:** medium threshold — pattern of documented incidents or single serious incident with strong documentation
   - **Termination for cause:** high threshold — documented pattern through prior corrective action, or single incident with overwhelming evidence and legal review
   - **Regulatory referral or legal action:** very high threshold — evidence that would survive discovery and meet the applicable legal standard of proof
   
   Calibrate enforcement action to evidence threshold rather than to urgency.

4. **While building the case, implement interim protections.** Delay does not mean inaction. While building the evidentiary record:
   - Restrict the subject's access to the resources, systems, or people relevant to the misconduct
   - Ensure ongoing misconduct is documented as it continues, not just initial incidents
   - Brief legal counsel on the developing situation without triggering premature formal action
   - Protect witnesses and evidence from interference by the subject
...
5. **Determine whether the subject's power creates special procedural requirements.** Enforcement against senior leaders — executives, board members, major clients, powerful regulators — has different requirements than enforcement against individual contributors:
   - Senior leader enforcement typically requires board-level or independent party involvement to establish impartiality
   - Legal counsel review of the evidentiary record before any action is taken
   - Documentation that the enforcement process itself was procedurally clean (independent investigation, no conflicts of interest in the decision-makers)
...
6. **Act decisively once the threshold is met.** The purpose of building an airtight case is not to delay indefinitely but to act at maximum strength. Once the evidentiary threshold is met and procedural requirements are satisfied, act promptly and completely. The failure mode opposite to premature enforcement is indefinite delay that allows ongoing harm while the case becomes theoretically stronger. Set a threshold; meet it; act.

## Rules

- Premature enforcement is not strong enforcement — it is weak enforcement with urgency. The subject can contest the evidence, claim overreach, and often prevail, which simultaneously fails to achieve accountability and strengthens the subject's position.
- Document before you need it, not after. The moment you realize documentation will be needed, it is usually already too late to create the most valuable records: contemporaneous observations from before the enforcement decision. Begin documentation at detection, not at enforcement.
- Power asymmetry increases the evidence threshold. Enforcement against someone with more resources, more institutional relationships, and more capacity to contest the action requires a stronger case than enforcement against someone without these advantages. This is not unfair — it is accurate. Account for the subject's capacity to challenge the enforcement when assessing case readiness.
- Interim protection is not enforcement. While building a case, taking steps to limit ongoing harm — restricting access, monitoring, separating parties — is not premature enforcement. Premature enforcement is formal action (disciplinary, legal, regulatory) before the evidentiary threshold is met. Interim protection is prudent risk management, not enforcement.
...
- **Confusing documentation delay with strategic delay.** The prescription to delay enforcement until the case is airtight is not a prescription to delay documentation. Documentation should begin immediately on detection. Enforcement action follows documentation; it does not substitute for it.
- **Acting on urgency rather than evidence.** Pressure to act quickly — from witnesses, from the media, from leadership, from your own discomfort with the ongoing misconduct — is constant. It does not change the evidentiary calculus. Premature action taken under urgency pressure fails at a predictably higher rate than action taken when the threshold is met.
- **Treating the document-notify-enforce sequence as bureaucratic formality.** The sequence is not formality — it is the mechanism by which enforcement is made unchallengeable. Enforcement actions that skip steps lose in challenge; enforcement actions that follow the sequence prevail.
- **Failing to protect victims while building the case.** The interim protection obligation is real. Building an airtight case does not justify allowing ongoing harm to continue unmitigated. Separate parties, restrict access, and monitor ongoing activity while the record is being built.
