...
tags: [business, strategy, sun-tzu, art-of-war, deterrence, positioning, win-without-fighting, pre-conflict, strategic-hierarchy, competitive-strategy]
verified: true
---
...
### Step 1: Define the strategic objective with precision before selecting the method
...
### Step 2: Attempt plan-level disruption first — can you make the opponent's strategy non-viable?
...
- **Standards establishment:** Establish the technical standard, regulatory framework, or industry norm that makes the opponent's approach incompatible with the market's direction before they can build critical mass
- **Resource pre-emption:** Secure the specific resources (talent pool, supplier relationships, regulatory approvals, distribution exclusivity) that the opponent's strategy depends on, before they can acquire them
- **Timing disruption:** Launch a product, standard, or capability that resets the market's expectations before the opponent's launch — making their planned product land in a shifted context where its differentiation is reduced
- **Strategic ambiguity:** Maintain sufficient ambiguity about your own plans that the opponent cannot optimise their strategy against a known competitive position
...
### Step 3: If plan disruption is insufficient, move to alliance disruption — isolate the opponent
...
- **Partnership pre-emption:** Form the partnerships the opponent needs before they can — with key distributors, system integrators, ecosystem partners, or reference customers whose endorsement the opponent needs for market credibility
- **Coalition building:** Assemble a coalition of partners who have shared interests in preventing the opponent's strategy from succeeding — customers who prefer an alternative, complementors who would be disadvantaged by the opponent's dominance, regulators who have concerns about the opponent's approach
- **Alliance poisoning:** Make it costly or risky for potential partners to commit to the opponent — through exclusive arrangements, risk-sharing commitments, or demonstration that your alternative offers better alignment with the partner's interests
- **Information operations:** Ensure that the market has accurate information about the risks and costs of the opponent's approach — reducing the confidence with which partners will commit to the opponent's ecosystem

### Step 4: If alliance disruption is insufficient, establish deterrence through positioning
...
- **Capability:** The threat must be credible — the deterring party must have a real capability to execute the confrontation at an acceptable cost to themselves
- **Communication:** The opponent must understand what behaviour the deterrence is designed to prevent and what the response would be
- **Credibility:** The deterring party must have demonstrated the willingness to execute threats in comparable situations — deterrence by a party who has consistently not followed through on threats is not credible

Positioning for deterrence:
- Accumulate the capability (financial reserves, market position, legal IP portfolio, distribution reach) that makes direct confrontation costly for the opponent
- Communicate the deterrence posture clearly — not as a threat, but as a description of your position and the consequences of competitive action
- Demonstrate the willingness to respond to direct competitive action in comparable situations — even at some cost to yourself — to establish the credibility of the deterrent

### Step 5: Escalate to direct confrontation only when higher-level options are exhausted

Direct confrontation is appropriate when:
- Plan-level disruption is no longer viable (the opponent's strategy is already executing and cannot be interrupted at the planning stage)
- Alliance disruption has failed or is not applicable (the opponent's partnerships are already formed and the coalition is not available)
- Deterrence has failed (the opponent is proceeding despite the deterrence posture)
- The cost of continued higher-level competition exceeds the expected cost of direct confrontation

When escalating to direct confrontation:
- Escalate decisively — partial direct confrontation that can be sustained indefinitely often preserves the competitor rather than defeating them
- Maintain the option to return to higher-level competition — even during direct confrontation, plan-level and alliance-level interventions can operate in parallel
- Define the exit criteria — what does winning look like at the direct confrontation level, and when should the confrontation be ended if it is not achieving the objective?

### Step 6: Maintain the hierarchy posture during direct confrontation
...
- Continue plan-level disruption: attacking the opponent's strategy for the next phase while engaging directly in the current phase
- Continue alliance management: preventing the opponent from building new alliances during the direct engagement that would change the balance
- Maintain deterrence posture for new competitive fronts that may open during the direct engagement
