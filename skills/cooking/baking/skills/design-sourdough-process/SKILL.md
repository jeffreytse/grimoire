...
tags: [cooking, baking, sourdough, bread, fermentation, starter, levain, dutch-oven, gluten]
verified: true
---

# Design Sourdough Process
...
### Step 1: Maintain a healthy starter
...
**Feeding schedule:**
- **Active baking:** Feed every 12 hours at room temperature (70–75°F / 21–24°C). Use the starter when it has doubled and is just beginning to dome or fall — this is peak activity.
- **Maintenance:** Keep in the fridge. Feed once a week. Remove from fridge 4–12 hours before baking and feed once to reactivate.
...
### Step 2: Mix the dough — autolyse first
...
1. Mix flour and 350g of the water (hold back 25g) with your hand until no dry flour remains. Cover and rest 30–60 minutes.
2. Add starter and remaining water. Squeeze through your fingers until fully incorporated.
3. Add salt. Squeeze again until incorporated. The dough will feel slack and rough.
...
- Wet your hand. Grab one side of the dough, stretch it up as far as it will go without tearing, fold it over to the opposite side. Rotate the bowl 90° and repeat. Complete all four sides = one set.
- Each set strengthens the gluten network. After 4 sets, the dough should feel noticeably stronger and more elastic.

**Signs bulk is complete:**
- Dough has grown 50–75% in volume (not necessarily doubled)
- Surface is domed, with visible bubbles underneath
- Dough jiggles like jello when you shake the bowl
- A small piece stretched between your fingers shows a thin, translucent windowpane (gluten window test)
...
1. Remove dough from refrigerator. Place a sheet of parchment paper over the banneton and flip it. The dough should release seam-side down.
2. Score quickly with a sharp blade (lame, razor blade, or sharp serrated knife) at a 30–45° angle. A single slash 4–6 inches long down the centre is sufficient. Scoring controls where the loaf expands and prevents blowouts.
3. Carefully lower the parchment and dough into the preheated Dutch oven. Cover with lid.

**Bake schedule:**
- **20 minutes at 500°F (260°C) with lid on** — Steam trapped inside allows the crust to remain extensible during oven spring. The loaf rises significantly in this phase.
- **20–25 minutes at 450°F (230°C) with lid off** — Crust browns and crisps via Maillard reaction and caramelisation.
...
- Never add salt at the same time as the starter — salt inhibits yeast activity. Add sequentially, not simultaneously.
- Maintain baker's percentages: changing hydration changes everything. Start at 75% and adjust once you understand the dough's feel.
- If the dough isn't rising after 2 hours at bulk start, your starter was not active enough. There is no rescue — start over with an active starter.
- Score decisively with one motion. Hesitating tears instead of cuts.
- Do not open the Dutch oven during the first 20 minutes of baking — releasing steam prevents oven spring.
- Whole grain flour absorbs more water. Adding whole wheat or rye will make the dough stiffer; compensate by adding 10–20g more water per 100g whole grain added.

## Examples

**Standard Tartine-method country loaf:**
- 80% bread flour, 20% whole wheat, 75% hydration, 20% starter, 2% salt
- Autolyse 45 min → add starter + salt → 4 stretch-and-folds at 30-min intervals → bulk 4.5 hours at 76°F → pre-shape → bench rest 25 min → final shape → banneton → refrigerate 14 hours → bake 500°F/20 min lid on, 450°F/22 min lid off
- Result: open crumb, crackly crust, mild-to-moderate tang
