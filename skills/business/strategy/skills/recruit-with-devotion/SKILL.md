...
tags: [business, strategy, three-kingdoms, recruiting, talent, liu-bei, zhuge-liang, three-visits, co-founder, advisor, exceptional-talent]
verified: true
---
...
### Step 1: Identify the specific skepticisms — not the stated objections
...
### Step 2: Make the first approach personal, specific, and non-demanding

The first approach establishes what kind of recruiter you are:

- **Personal:** You — not a recruiter, not an assistant, not an email from HR. The person who will actually work with them makes the first contact.
- **Specific:** Reference their actual work, their actual situation, their actual thinking — not the generic "we're looking for great people" pitch. Demonstrate that you have studied what they have done and understand its significance.
- **Non-demanding:** Do not ask them to do anything on the first approach. No "would you take a call?" No "can we schedule some time?" Express interest and understanding, and let them respond on their terms.
...
### Step 3: Accept the first non-answer as a signal, not a rejection
...
- The approach was received but the demonstration was insufficient
- The specific skepticism that matters has not yet been addressed
- The recruiter needs to demonstrate more before the conversation is worth having
...
### Step 4: Return with the specific demonstration the first approach identified
...
- If the skepticism was "you don't understand my work": prepare a specific analysis of their domain that shows deeper comprehension than the first approach
- If the skepticism was "you won't let me do the work properly": bring a specific example, an existing team member who can speak to working autonomy, or a concrete governance structure
- If the skepticism was "the mission isn't real": bring evidence of progress, specific customers, a board that demonstrates commitment to the mission
...
### Step 5: Repeat until genuine closure — commitment or definitive refusal
...
### Step 6: Deliver on what the devotion implicitly promised
...
- Genuine mission commitment — the mission must remain genuine
- Autonomy and respect for their expertise — the working relationship must reflect that autonomy
- Personal engagement from the leader — the leader must remain engaged, not delegate to a manager
- Understanding of their specific domain — the leader must continue to demonstrate that understanding
...
- Never send an envoy for the first contact. The three-visits approach requires personal engagement from the person who will actually work with the recruit. Delegating the first contact to a recruiter, an executive assistant, or an intermediary signals that your interest is not genuine enough to commit your own time.
- Address specific skepticisms, not generic appeal. Each approach must demonstrate something specific in response to what the previous approach revealed. "We'd really love to have you" repeated multiple times is not the three-visits pattern — it is noise that signals you are not listening.
- Do not increase the financial offer as a substitute for the specific demonstration. Financial escalation addresses the wrong test. The extraordinary person who is screening for genuine understanding and commitment will correctly read a financial escalation as "they do not know how to demonstrate what I actually need." It reduces rather than increases the signal.
- Distinguish screening distance from genuine refusal. Persistence through screening distance is appropriate; persistence past genuine refusal is harmful. The signals differ: screening distance is imprecise and creates space for follow-up; genuine refusal is specific and closes the door explicitly.
- Do not use understanding as a technique. Demonstrating genuine comprehension of the recruit's work and situation cannot be faked efficiently — the depth required is incompatible with performance. If you find yourself researching someone's work primarily to display the research rather than to actually understand it, the approach will be legible as performative. Genuine comprehension comes from genuine interest in the recruit's work.
- Deliver the implicit contract. Once the person has joined on the basis of what the devotion demonstrated, the working relationship must reflect what was signaled. Track the implicit commitments made during the recruitment and treat them as binding.

## Examples

**Steve Jobs recruiting John Sculley (1983):**
Jobs spent months engaging Sculley in substantive conversations about consumer psychology, brand building, and the future of personal computing — not about the PepsiCo CEO role or what Apple could offer him. Jobs demonstrated specific understanding of Sculley's professional concerns: that Sculley had built a great marketing career but had not yet built something that would define a generation. The line "do you want to sell sugar water for the rest of your life?" was not a pitch — it was an articulation of the specific skepticism Jobs believed was blocking Sculley ("is this work actually meaningful?"), delivered with enough precision that Sculley later described it as the moment he knew Jobs genuinely understood what mattered to him. The three-visits pattern compressed into the conversation.

**Recruiting a principal engineer from a large technology company:**
