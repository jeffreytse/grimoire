...
### Step 1: Assess your current capability gap — can you withstand the dominant player's response today?
...
Assess:
- **Defensive response capacity:** What would the dominant player do if they perceived you as a threat today? Price war, acquisition offer, partnership trap, regulatory lobbying, talent raid, competing product launch? Do you have the resources, customer loyalty, and market position to survive or respond to each?
- **Development timeline:** How long until you reach the threshold at which you can withstand their response? Months? Years?
- **Trigger visibility:** Is your current development trajectory visible to the dominant player? Are you growing in segments they monitor closely?
...
### Step 2: Identify which specific capabilities would trigger the dominant player's response if visible
...
- **Non-threatening:** Development in segments the dominant player has determined are unattractive, below their margin threshold, or serving customers they have deprioritised
- **Threatening:** Development in segments the dominant player is currently serving, investment in distribution or platform that duplicates their key asset, public claims of capability that directly compete with their market position
...
### Step 3: Design the concealment approach — selective visibility, not deception
...
Approaches:
- **Segment positioning:** Enter the market in a segment the dominant player has determined is unattractive. Build capability there. Move upmarket only when strong enough.
- **Partnership framing:** Maintain a relationship with the dominant player (as vendor, partner, customer) that frames you as complementary rather than competitive. This relationship provides information about the dominant player's threat assessment; it also makes aggressive competitive action more costly for them.
- **Feature omission:** Do not build features that would directly compete with the dominant player's core value proposition until you have built everything else needed. The absence of the directly competitive feature keeps your threat assessment low.
- **Communication discipline:** Avoid public statements about market share targets, competitive positioning relative to the dominant player, or capability roadmaps that would make competitive intent visible. Internal ambition need not be external positioning.
- **Metric suppression:** Avoid publishing growth metrics that would signal the pace of your capability development to the dominant player's competitive intelligence function.

### Step 4: Maintain the concealment actively during the development phase

Capability concealment degrades without active maintenance. Common drift patterns:
- Sales teams make aggressive competitive claims to close deals that reach the dominant player's intelligence function
- Marketing teams publish growth claims to attract investor attention that also alerts the dominant player
- Engineers build features requested by customers that directly replicate the dominant player's differentiators prematurely
- Fundraising materials describing competitive positioning circulate more widely than intended
...
### Step 5: Define the exit conditions — when does concealment end?
...
- **Strength threshold:** What specific metric (revenue, customer count, product capability, distribution reach) indicates you can withstand the dominant player's full defensive response?
- **Market position:** At what point is your customer base loyal enough to withstand a price war or competing product from the dominant player?
- **Ecosystem lock-in:** Have you established platform dependencies, switching costs, or ecosystem relationships that make displacement significantly more costly for customers?
...
### Step 6: Execute the transition at the right moment
...
- The dominant player's response will be triggered at this moment — they will now perceive the full competitive threat
- You should be positioned to withstand their response at the moment you trigger it
- The transition announcement frames the competitive reality on your terms rather than theirs
