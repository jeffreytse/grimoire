...
# Apply Competitive Encirclement
...
### Step 1: Map the opponent's countermoves before you announce
...
### Step 2: Pre-empt the most damaging and accessible countermoves — in silence

The encirclement must be executed before the main move is announced. Sequence:

1. Identify the 2–3 most critical countermoves to foreclose
2. Approach the relevant parties (distributors, talent, suppliers, partners) without revealing the reason for the approach
3. Secure commitments: exclusive agreements, employment contracts, supply reservations, partnership MoUs
4. Keep the encirclement activities operationally separate from the main-move preparation to avoid intelligence leakage
...
### Step 3: Verify the encirclement before committing to the main move

Before announcing, audit what has been secured:
- Are the exclusive agreements enforceable and will they hold under competitive pressure?
- Is the talent actually committed — signed and starting — or merely in conversation?
- Does the supply reservation cover the required volume for the main move's scale?
- Is the regulatory position actually established, or pending?
...
### Step 4: Execute the main move after the encirclement is complete
...
- Announce when the opponent cannot immediately access the foreclosed positions
- Use the announcement to further signal the encirclement: "exclusive partnership with X", "long-term supply agreement with Y" communicate that the exits are closed
- Move fast in the announcement period to establish irreversible position before the opponent finds alternative routes

### Step 5: Maintain the encirclement — exclusivity requires active management
...
- Renew exclusivity agreements before they expire; renegotiate from strength, not desperation
- Retain the talent whose commitment forecloses the opponent's recruitment option
- Maintain the supply relationship as a strategic priority, not a procurement exercise
- Monitor for the opponent's attempts to build around the foreclosed positions; respond before alternatives are established

## Rules

- Execute the encirclement in silence. Disclosure of intent before the encirclement is complete allows the opponent to pre-empt each position you are trying to secure. Operational security during encirclement is not optional.
- Encirclement must be genuine. Exclusive agreements that have easy exits, talent that can be easily replaced, regulatory positions that are contested — these create false confidence. The encirclement must be real enough to actually foreclose the countermove.
- Foreclose the most damaging countermoves first, not the easiest. The temptation is to secure the positions that are easiest to reach; the requirement is to secure the positions whose foreclosure most damages the opponent's ability to respond.
- Assess the cost of encirclement against the strategic return. Exclusivity commands premium pricing; talent hired before the need commands premium compensation; supply reservations require advance commitment. Encirclement is expensive. Verify the strategic value of the main move justifies the encirclement cost.
- Maintain active management of the encirclement post-execution. Positions closed at announcement will open over time unless actively maintained. The encirclement is not a one-time action.

## Examples

**Microsoft's OEM per-CPU licensing (distribution encirclement, 1980s):**
...
**Apple + AT&T exclusive iPhone launch (carrier distribution encirclement, 2007):**
Apple secured an exclusive carrier agreement with AT&T for the original iPhone launch in the US, giving AT&T exclusivity in exchange for revenue sharing and carrier subsidy. The encirclement foreclosed the primary US mobile distribution channel before competing smartphones existed. Competing device manufacturers — Nokia, BlackBerry, Palm — had to either launch without AT&T's distribution (Verizon, Sprint) or accept worse terms from AT&T when exclusivity eventually expired (2011). Apple established the iPhone's market position during the four-year exclusivity window at a time when competing hardware was unprepared to respond on the AT&T channel.

**Pharma patent continuation filing (IP encirclement):**
