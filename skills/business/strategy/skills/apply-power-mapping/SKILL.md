---
name: apply-power-mapping
description: Use when engaging with any organization — customer, partner, regulator, acquirer, or internal — to map actual decision authority and influence separately from the formal org chart, because nominal titles and actual power routinely diverge, and strategies built on formal hierarchy fail when the real decision-makers are elsewhere
source: "荣枯鉴·制御篇 (Feng Dao, ~10th century AD) — 强者为尊，知其所处则可制之 (Know where actual power resides, and you can work with it); Challenger Sale (Adamson & Dixon, CEB, 2011) — map the full buying committee, not just the economic buyer; Gartner B2B purchase research (2015–2023) — average enterprise deal involves 6–10 stakeholders; Organizational Network Analysis (ONA — Deloitte, IBM, CrossLead); PMI PMBOK stakeholder mapping; Jeffrey Pfeffer \"Power\" (Stanford GSB, 2010)"
tags: [strategy, influence, organizational-dynamics, stakeholder-management, enterprise-sales, decision-making]
verified: true
---
...
The 荣枯鉴 observes that in every organization, effective power resides with those who actually command resources, loyalty, and decisions — not necessarily with those who hold the titles. The failure to distinguish nominal authority from actual power is one of the most consistent causes of strategic failure: the leader engages the wrong person, misses the real objection, or builds an approach based on a map that doesn't match the territory. Knowing where actual power sits allows you to work with the actual decision-making structure rather than the theoretical one.
...
1. **Map all stakeholders who touch the decision.** List every person who has any of the following: budget authority, technical veto, operational input, formal approval requirement, informal opinion-forming role, or direct access to the economic decision-maker. Cast wide initially — it is easier to remove a stakeholder from the map after confirming their non-involvement than to discover a missed stakeholder after your strategy has deployed.

2. **Classify each stakeholder on two dimensions: formal authority and actual influence.** For each person on the list, assess:
   - **Formal authority:** what do they formally have the right to approve, reject, or require? (Org chart, procurement rules, sign-off thresholds)
   - **Actual influence:** who does the actual decision-maker consult? Whose concerns, when raised, reliably change outcomes? Who does the economic buyer defer to on specific topics (technical, operational, financial)?
...
6. **Identify champions and activate them.** A champion is a stakeholder with actual influence who is genuinely supportive of your objective. Champions should be leveraged to reach stakeholders you cannot access directly, to translate your proposal into the organization's language and priorities, and to pre-address objections before they reach formal decision meetings. A well-briefed internal champion is more effective than any external presentation.

7. **Update the map throughout the engagement.** Power maps are not static — people change roles, lose influence, gain it, change their position. Track changes: who has been consulted most recently; who's opinion was sought when an obstacle arose; who is now closer to or further from the actual decision-maker. The most critical power-mapping failure is treating the initial map as fixed and missing the dynamic changes that redirect the real decision.

## Rules

- Titles are hypotheses, not facts. A VP title is a hypothesis that this person has significant authority. Verify through observed behavior: does their opinion change outcomes? Does the economic buyer consult them? Treat every title as a starting hypothesis to be tested, not confirmed.
- Low-authority, high-influence stakeholders are the most commonly missed. Because power-mapping instinctively starts with the org chart, these people — the technical expert whose word is trusted, the executive assistant who controls access, the board advisor who shapes thinking — are systematically underweighted. Actively hunt for them.
- Map the topic-specific authority, not general authority. Most stakeholders have authority that is specific to domains (technical decisions, financial decisions, operational decisions). A person with high authority on technology decisions has low authority on commercial terms. Build a domain-specific map, not a general seniority ranking.
- Never engage based on the org chart alone. The org chart describes reporting structure, not decision authority. These overlap significantly at the top of organizations and diverge significantly in the middle and operating layers. Every significant engagement requires its own power map.
...
- **Mapping only the formal hierarchy:** The org chart is the starting point, not the map. Stopping at formal titles systematically misses the hidden influencers who often determine outcomes.
- **Assuming the map is static:** People change positions, lose sponsors, gain influence. Power maps built for a deal or initiative 6 months ago may be significantly outdated. Update continuously.
- **Engaging the wrong level:** Both too-high (engaging the CEO when the real decision is made by a VP) and too-low (engaging a manager when a C-suite champion is needed) produce failure. Match the engagement level to the actual power level.
- **Neglecting blockers until they block:** Blockers who are identified but not engaged before the decision point produce last-minute rejections that are very difficult to reverse under time pressure. Identify blockers early; address their concerns before the formal decision stage.
- **Mapping without acting:** A detailed power map that doesn't change the engagement strategy produces no value. The output of power mapping is a revised engagement plan — different people to engage, different sequence, different messages for each stakeholder's specific concerns.
