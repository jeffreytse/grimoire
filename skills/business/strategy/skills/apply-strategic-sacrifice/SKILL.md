...
### Step 1: Map your portfolio — identify the peach and the plum
...
The peach: high strategic value, worth disproportionate defence.
The plum: lower strategic value, acceptable to sacrifice to protect the peach.
...
### Step 2: Verify the sacrifice is genuinely smaller in strategic value than the gain
...
- **Preserve trade (Stratagem #11):** Will protecting the peach produce more value over the relevant time horizon than the cost of losing the plum?
- **Attract trade (Stratagem #17):** Will what you attract with the brick justify the value of the brick, after the probability that the jade never arrives?
...
### Step 3: Sacrifice decisively — half-measures cost the same as full sacrifice
...
- Reducing investment in a product line to the point where it cannot compete, while refusing to shut it down — the product deteriorates without freeing the resources to concentrate elsewhere
- Pricing a loss-leader product high enough to avoid losses but low enough to confuse positioning — neither profitable nor attractive enough to drive the target behaviour
- Giving up a board seat conditionally — the condition limits the value of the concession to the recipient, reducing the likelihood of attracting the jade

Sacrifice completely or do not sacrifice. The sacrifice must be sufficient to produce the intended response.

### Step 4: Ensure the recipient values the sacrifice

A sacrifice that is not valued by the counterpart produces no gain:

- A reference account offered at 80% discount to a customer who would have paid full price anyway is not a strategic sacrifice — it is a discount
- A loss-leader product offered in a market where customers do not want the bait is not casting a brick — it is giving away bricks
- Giving up a board seat to an executive who does not care about board seats does not retain the executive

Verify in advance that the sacrifice is genuinely attractive to the counterpart whose behaviour you want to influence.

### Step 5: After the sacrifice, defend what was preserved without compromise
...
- Concentrate fully on the position preserved — do not underinvest because you are mourning the loss
- If the sacrifice was an attract trade, secure the jade before giving additional bricks
- Do not allow the sacrifice to be interpreted as general weakness — frame it as a deliberate choice

## Rules

- Never sacrifice what you cannot afford to lose. The plum must be genuinely expendable relative to the peach. A sacrifice that, if reversed, would threaten the peach is not a strategic sacrifice — it is an existential risk.
- Make the value comparison explicit. "This feels like the right trade" is not a sufficient basis for strategic sacrifice. Map the strategic value of what you give up and what you gain, and require that the gain exceeds the loss before committing.
- Sacrifice completely. Half-sacrifices produce no strategic benefit while incurring the full cost of the sacrifice. The decision to sacrifice implies the decision to follow through.
- Do not sacrifice under time pressure without completing the valuation. Urgency is the primary condition under which bad trades are accepted. Build in a minimum reflection period before committing to a sacrifice under crisis pressure.
- Distinguish sacrifice from rationalised loss. A sacrifice is a deliberate trade with an identified gain. A rationalised loss is a loss that is reframed as strategy after the fact. The difference is whether the gain was identified before the sacrifice was made.

## Examples

**Amazon Kindle priced below cost (brick to attract the jade of the e-book ecosystem):**
Amazon priced the original Kindle at $399 in 2007 — approximately at cost, with no hardware margin. The sacrifice: hardware margin that Amazon would have earned. The jade: customer commitment to the Amazon ecosystem for all future e-book purchases (30% margin on each e-book, lifetime value of a Kindle customer). The trade was asymmetric: the one-time hardware sacrifice bought a recurring revenue relationship. By 2011, Amazon had sold more e-books than physical books; the Kindle sacrifice had captured the market. Barnes & Noble and Sony, who priced their e-readers at full margin, sacrificed the market share that Amazon captured.

**Startup sacrificing its worst enterprise account to retain its best team:**
A 60-person SaaS startup has three enterprise accounts. Account A is the largest by revenue (30%) but demands custom development, consumes 40% of engineering capacity, and has low satisfaction scores. Accounts B and C are smaller but expanding, have high satisfaction, and consume normal support. The startup's senior engineers are burning out on Account A's custom demands. Strategic sacrifice: notify Account A that custom development is no longer available under their contract terms, and offer a refund for the remaining term. Sacrifice cost: 30% of revenue for one quarter. Gain: engineers' full capacity redirected to Accounts B and C, both of which expand by 50% over the following year — generating more than the lost Account A revenue. The plum (Account A revenue) is sacrificed to protect the peach (engineering team and product velocity).

**Market share for margin (sacrifice the plum territory to protect the premium position):**
A premium SaaS product faces a price war in the SMB segment from a well-funded competitor willing to sell at a loss. Rather than matching the price war (which destroys margin in all segments), the product raises prices in SMB while concentrating on enterprise, where the competitor has not yet invested. The SMB market share is the plum: it is sacrificed to protect enterprise margin (the peach). Three years later, the price-war competitor has captured the SMB segment profitably but has not built enterprise sales capacity; the premium product has expanded enterprise ACV and is profitable. The sacrifice was asymmetric: SMB churn hurt revenue in the short term; enterprise concentration built a moat the price-war competitor cannot easily replicate.
