...
### Step 1: Map all contested areas
...
### Step 2: Classify each area as 虛 (empty) or 實 (full)
...
**虛 (empty) signals:**
- Opponent is present but under-investing
- Opponent's product/service is a poor fit for this segment's specific needs
- Opponent is distracted by a primary battle elsewhere
- Opponent has structural disadvantages in this area (high cost to serve, regulatory complexity, cultural distance from their core)
- The area is new and the opponent has not yet committed

**實 (full) signals:**
- Opponent has deep customer relationships, high switching costs, and consistent investment
- Opponent has a structural cost or capability advantage in this area
- Opponent has made public commitments to defend this area
- Winning here would require defeating the opponent's primary strength

### Step 3: Concentrate all force on 虛; abandon 實
...
- Are all resources (budget, headcount, leadership attention) pointed at the 虛 areas?
- Have you explicitly stopped investment in 實 areas where you cannot win?
- Is there a single point of maximum concentration, or is force still dispersed?
...
### Step 4: Be formless — prevent the opponent from concentrating against you
...
- Do not announce your target segment, account, or market focus publicly before you have established a defensible position
- Create the appearance of activity in multiple areas simultaneously while concentrating force in one
- Use the orthodox (正) force to draw the opponent's attention and defensive resources to the wrong area while the unorthodox (奇) force concentrates on the real target
- Move faster than the opponent's intelligence cycle — establish the position before they can respond

### Step 5: Shape the opponent's concentration
...
**Shaping tactics:**
- Engage them in a secondary market to draw resources away from the primary target
- Create a public competitive dispute in an area that is not your true objective
- Make an acquisition or partnership announcement that signals a threat in the wrong direction
- Create urgency in a market they value but you are willing to concede, drawing their investment away from your real target

### Step 6: Maintain initiative — never let the opponent dictate the contest point
...
- You are responding to competitive moves rather than making them
- Your roadmap is driven by competitor feature parity rather than your segment's specific needs
- You are defending existing accounts rather than expanding
...
- Never spread force to achieve coverage. Coverage is not a strategy. Concentration in the right area is a strategy.
- Explicitly decide what you are abandoning. Concentration requires abandonment. Name the 實 areas you are not contesting and remove resources from them.
- Maintain formlessness until the position is established. Once the opponent knows your concentration point, they will attempt to counter-concentrate. Move fast; don't signal.
- Control the initiative. The opponent who dictates where battles happen controls the campaign. If you are reacting, you have lost initiative — reassess and find a new 虛 area.
- Reassess 虛/實 continuously. An area that was 虛 last quarter may be 實 this quarter if the opponent has responded to your concentration. Update the map regularly.

## Examples

**Thiel/PayPal: dominate online auctions first (segment concentration):**
PayPal's first concentration: eBay power sellers. Not "all e-commerce" — a specific, 虛 segment where existing payment solutions were terrible and the opponent (traditional financial services) had no interest in serving. 100% of product and growth resources concentrated on eBay power sellers until PayPal had dominant share of that segment. Then expanded. eBay eventually acquired PayPal for $1.5B — they could not dislodge them from their core segment.

**Feature concentration (product team, 3 engineers):**
Map: competitor has features in CRM integration, reporting, mobile app, API, and team management. Assess: CRM integration (incumbent has deep Salesforce integration — 實); reporting (adequate — 實); mobile (weak — 虛); API (undocumented, poor — 虛); team management (solid — 實). Concentrate all 3 engineers on mobile + API. Build 2 features to superiority rather than 5 features to mediocrity. Win the mobile-first and developer segments; expand from there.

**Geographic market expansion (Amazon's density model):**
Amazon's physical expansion (grocery, retail) uses force concentration: launch in one city, achieve delivery density that makes unit economics work, then expand. Launching in 50 cities simultaneously at insufficient density produces poor unit economics everywhere. One city at full density produces a profitable model to replicate.
